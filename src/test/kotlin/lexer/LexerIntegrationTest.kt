...
class LexerIntegrationTest: FunSpec({
    test("Should properly parse all tokens") {
        val tokens = listOf(
            ...
            LexerToken(TokenType.NumConstant, 0, 2, 22),
            ...
            LexerToken(TokenType.NumConstant, 1, 3, 25),
            ...
            LexerToken(TokenType.NumConstant, 0, 5, 34),
            ...
            LexerToken(TokenType.NumConstant, 1, 8, 21),
            ...
            LexerToken(TokenType.NumConstant, 6.5, 14, 27),
