...
data class TypedIdentifier(val name: String, val type: Any)
...
data class Function(val name: String, val type: Any, val parameters: Array<TypedIdentifier>, val block: Array<Statement>)

data class Program(val funDeclarations: Array<Function>)
